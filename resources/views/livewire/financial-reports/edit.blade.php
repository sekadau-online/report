...
new class extends Component {
    ...
    public ?string $originalPhoto = null;
    ...
    public function mount(FinancialReport $report): void
    {
        ...
        $this->amount = (string) $report->amount;
        $this->report_date = $report->report_date->format('Y-m-d');
        $this->category = $report->category;
        $this->existingPhoto = $report->photo;
        $this->originalPhoto = $report->photo;
    }
    ...
    public function save(): void
    {
        ...
        if ($this->removeExistingPhoto && $this->originalPhoto) {
            Storage::disk('public')->delete($this->originalPhoto);
            $photoPath = null;
        }
        ...
        session()->flash('status', 'Laporan keuangan berhasil diperbarui.');
    ...
    public function deleteExistingPhoto(): void
    {
...
<section class="w-full">
    ...
    <x-financial-reports.layout :heading="__('Edit Laporan')" :subheading="__('Perbarui data laporan keuangan')">
                ...
                <div class="mt-2">
                    ...
                    @if ($existingPhoto && !$photo)
                        <div class="relative mb-4 inline-block">
                            <img src="{{ Storage::url($existingPhoto) }}" alt="Current photo" class="h-48 w-auto rounded-lg border border-neutral-200 object-cover dark:border-neutral-700">
                            <button
                                type="button"
