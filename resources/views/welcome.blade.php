                    ...
                    <div class="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div class="text-center lg:text-left space-y-8">
                            ...
                            <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                                ...
                                <a href="{{ site_setting('primary_link_url', 'https://laravel.com/docs') }}" target="_blank" class="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white dark:bg-slate-800 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-xl text-base font-semibold transition-all border border-slate-200 dark:border-slate-700 hover:-translate-y-0.5">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                                    </svg>
                                    {{ site_setting('primary_link_text', 'Dokumentasi') }}
                                </a>
                            </div>
                        </div>
